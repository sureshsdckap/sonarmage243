...
class CustomerCreatePost
{
     ...
     * @param \DCKAP\Extension\Helper\Data $dckapHelper
     */
    ...
    public function afterExecute(CreatePost $createPost, $result)
    {
        ...
        if ($emailPost) {
            ...
            $customerFilter = $cusCollectFactory->addFieldToFilter('email', $emailPost)->addAttributeToFilter("website_id", array("eq" => $websiteId))->getFirstItem();
