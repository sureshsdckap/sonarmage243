                ...
                if ($fullActionName == $pageType || $pageType == 'allpage') {
                    ...
                    if (strpos($location, $type) !== false) {
                        if (strpos($location, 'top') !== false) {
                            $output = "<div id=\"mageplaza-productslider-block-before-{$type}-{$slider->getId()}\" class='mageplaza-productslider-block before'>$content</div>" . $output;
                        } else {
                            $output .= "<div id=\"mageplaza-productslider-block-after-{$type}-{$slider->getId()}\" class='mageplaza-productslider-block after'>$content</div>";
                        }
                    }
                }
            }
