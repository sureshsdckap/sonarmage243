...
namespace Cayan\Payment\Block\Adminhtml\Order\Item\Discount;
...
/**
 * Gift Card Refund Admin Order Item Block
 *
 * @package Cayan\Payment\Block
 * @author Igor Miura
 */
class Refund extends Item
{
    /**
    ...
    /**
     * Return refunded amount in order
     *
     * @return float
     */
    ...
    {
        return $this->priceHelper->currency($this->getRefundedAmount());
    }
