...
define(
    ...
    function ($, Component, quote, priceUtils, totals) {
        ...
        return Component.extend({
            defaults: {
                template: 'Cayan_Payment/cart/totals/cayancard'
            },
            removeGiftCode : function(code){
                var finalURL = window.checkoutConfig.payment.cayancard.giftcard_remove_url+"giftcode/"+code;
                $(location).attr('href', finalURL);
            },
            getCodes : function(){
                return window.checkoutConfig.payment.cayancard.giftcard_codes;
            },
            isVisible: function () {
                if(window.checkoutConfig.payment.cayancard.giftcard_discount > 0)
                    return true;
                else
                    return false;
            },
